...
// // fin verificacion del recaptcha
	...
	$template = str_replace('%message%', $message, $template);
		...
		$mail->FromName = 'Mobirama | Nuevo registro Payroll Services';
		$mail->addAddress('raul.garcia@mobirama.com.mx');
		$mail->addAddress('maximiliano.castillo@cclusterc.com.mx');
		$mail->addAddress('byker.23@gmail.com');
		$mail->isHTML(true);
	  	$mail->CharSet = 'UTF-8';
		$mail->Subject = 'Nuevo registro de contacto Payroll Services'; 
		$mail->Body = $template;
		// var_dump($db);
