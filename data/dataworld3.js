...
Highcharts.chart('container-guatemala', {
  ...
  credits: {
    text: 'IED = Inversión Extranjera Directa. Datos proporcionados por la Secretaría de Economía. ',
  },
  title: {
  ...
  data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-guatemala.csv',
...
Highcharts.chart('container-chile', {
    ...
    data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-chile.csv',
               beforeParse: function (csv) {
                   return csv.replace(/\n\n/g, '\n');
               }           
           },
...
Highcharts.chart('container-colombia', {
    ...
    data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-colombia.csv',
               beforeParse: function (csv) {
                   return csv.replace(/\n\n/g, '\n');
               }           
           },
...
Highcharts.chart('container-costarica', {
    ...
    data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-costarica.csv',
               beforeParse: function (csv) {
                   return csv.replace(/\n\n/g, '\n');
               }           
           },
...
Highcharts.chart('container-dominicana', {
    ...
    data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-dominicana.csv',
               beforeParse: function (csv) {
                   return csv.replace(/\n\n/g, '\n');
               }           
           },
...
Highcharts.chart('container-ecuador', {
    ...
    data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-ecuador.csv',
               beforeParse: function (csv) {
                   return csv.replace(/\n\n/g, '\n');
               }           
           },
...
Highcharts.chart('container-honduras', {
    ...
    data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-honduras.csv',
               beforeParse: function (csv) {
                   return csv.replace(/\n\n/g, '\n');
               }           
           },
...
Highcharts.chart('container-nicaragua', {
    ...
    data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-nicaragua.csv',
               beforeParse: function (csv) {
                   return csv.replace(/\n\n/g, '\n');
               }           
           },
...
Highcharts.chart('container-panama', {
    ...
    data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-panama.csv',
               beforeParse: function (csv) {
                   return csv.replace(/\n\n/g, '\n');
               }           
           },
...
Highcharts.chart('container-peru', {
    ...
    data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-peru.csv',
               beforeParse: function (csv) {
                   return csv.replace(/\n\n/g, '\n');
               }           
           },
...
Highcharts.chart('container-salvador', {
    ...
    data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-salvador.csv',
               beforeParse: function (csv) {
                   return csv.replace(/\n\n/g, '\n');
               }           
           },
...
Highcharts.chart('container-brasil', {
    ...
    data: {    csvURL: 'http://bdrex1.test/new_coine/data/com-brasil.csv',
               beforeParse: function (csv) {
                   return csv.replace(/\n\n/g, '\n');
               }           
           },
